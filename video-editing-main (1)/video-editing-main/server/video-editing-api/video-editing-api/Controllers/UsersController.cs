...
namespace video_editing_api.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        [HttpPost("UpdateInfo")]
        public async Task<IActionResult> UpdateInfo(AccountModel account)
        {
            try
            {
                ...
                //var normalizedEmail = await _userManager.UpdateNormalizedEmailAsync(account.Email);
                return Ok(new Response<object>(200, "", ""));
            }
            catch (System.Exception e)
            {
                return BadRequest(new Response<string>(400, e.Message, null));
